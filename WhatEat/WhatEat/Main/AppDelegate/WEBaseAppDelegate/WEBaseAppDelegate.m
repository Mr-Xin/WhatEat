...
#import "WEBaseAppDelegate.h"
#import <objc/runtime.h>
#import <objc/message.h>

@implementation WEBaseAppDelegate
...
- (BOOL)respondsToSelector:(SEL)aSelector {
    ...
    if (! canResponse && [[self appDelegateMethods] containsObject:NSStringFromSelector(aSelector)]) {
        canResponse = [[WEAppServiceManager sharedManager] proxyCanResponseToSelector:aSelector];
    }
    return canResponse;
}

- (void)forwardInvocation:(NSInvocation *)anInvocation {
    [[WEAppServiceManager sharedManager] proxyForwardInvocation:anInvocation];
}
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"WhatEat"];
