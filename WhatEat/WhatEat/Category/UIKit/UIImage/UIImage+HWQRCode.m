...
#import "UIImage+HWQRCode.h"

@implementation UIImage (HWQRCode)
...
#pragma mark - read QRCode from image
- (NSString *)stringOfQRCodeImage{
    CIDetector *detector = [CIDetector detectorOfType:CIDetectorTypeQRCode context:nil
                                              options:@{CIDetectorAccuracy : CIDetectorAccuracyHigh}];
    NSArray<CIFeature *> *features = [detector featuresInImage:[CIImage imageWithCGImage:self.CGImage]];
